...
public static partial class NullableExtensions
{
    ...
    /// <returns>
    /// Returns the result of the <c>map</c> function if the source value is defined.
    ...
    /// <summary>
    /// Maps the underlying value of a <see cref="Nullable{TSource}"/>.
    /// Otherwise, returns instance of <see cref="Nullable{TResult}"/> with no value.
    /// </summary>
    /// <param name="source">The source value to be mapped.</param>
    /// <param name="map">The map function.</param>
    /// <typeparam name="TSource">The type of the source value.</typeparam>
